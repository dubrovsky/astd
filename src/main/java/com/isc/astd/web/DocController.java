...
public class DocController {
    ...
    @GetMapping()
    public ResponseEntity<Response<DocDTO>> getAllDocs(@RequestParam long catalogId, @RequestParam File.BranchType branchType, PageableDTO pageableDTO, @AuthenticationPrincipal User user) throws IOException {
        PageRequestDTO<DocDTO> pageRequestDTO = docService.getAllDocs(catalogId, branchType, user, pageableDTO);
