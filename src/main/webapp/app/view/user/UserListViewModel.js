/*
 * File: app/view/user/UserListViewModel.js
 *
...
Ext.define('ASTD.view.user.UserListViewModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.user.userlistview',
    ...
    stores: {
        userStore: {
            remoteFilter: true,
            model: 'ASTD.model.UserModel'
        },
        positionStore: {
            autoLoad: true,
            model: 'ASTD.model.PositionModel',
            listeners: {
                load: 'onPositionStoreLoad'
            }
        },
        catalogStore: {
            autoLoad: true,
