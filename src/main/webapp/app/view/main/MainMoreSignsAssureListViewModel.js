/*
 * File: app/view/main/MainMoreSignsAssureListViewModel.js
 *
...
Ext.define('ASTD.view.main.MainMoreSignsAssureListViewModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.main.mainmoresignsassurelistview',
    ...
    stores: {
        moreSignsAssureStore: {
            remoteFilter: true,
            remoteSort: true,
            autoLoad: true,
            model: 'ASTD.model.MoreSignsAssureModel'
        }
    },
    formulas: {
