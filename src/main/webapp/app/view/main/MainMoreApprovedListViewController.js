/*
 * File: app/view/main/MainMoreApprovedListViewController.js
 *
...
Ext.define('ASTD.view.main.MainMoreApprovedListViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.main.mainmoreapprovedlistview',

    id: 'mainMoreApprovedListViewController',

    onGoToSelectedDoc: function(record) {
        this.fireEvent('goToSelectedDoc', record.get('docId'), this.getView(), 'APPROVED');
    },
    ...
    onGoToSelectedDocClick: function(button, e, eOpts) {
        var record = this.getViewModel().get('current.approvedFile');
