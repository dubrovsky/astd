/*
 * File: app/view/main/MainMoreSignsAssureListViewController.js
 *
...
Ext.define('ASTD.view.main.MainMoreSignsAssureListViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.main.mainmoresignsassurelistview',

    id: 'mainMoreSignsAssureListViewController',
    ...
    onGoToSelectedDocClick: function(button, e, eOpts) {
        var record = this.getViewModel().get('current.signAssureFile');
